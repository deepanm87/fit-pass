...
export function SessionCard({
  ...
  if (!activity || !venue || !startTime || !maxCapacity) {
    return null
  }
    ...
    <Link href={`/classes/${session._id}`}>
      ...
      >
        <div className="relative aspect-video overflow-hidden bg-muted">
          ...
          <div className="absolute inset-0 bg-linear-to-t from-black/60 via-transparent to-transparent opacity-0 transition-opacity duration-300 
