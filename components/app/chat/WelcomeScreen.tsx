...
function Suggestion({ icon, text, onClick }: SuggestionProps) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="flex items-center gap-3 rounded-xl border border-border bg-card p-3 text-left text-sm transition-all hover:border-primary/50 hover:border-primary/50 hover:bg-primary/5"
    >
...
export function WelcomeScreen({
  ...
  const suggestions = [
    ...
    },
    {
      ...
      text: "Recommended classes for weight loss"
    },
    {
  ...
  return (
    <div className="flex h-full flex-col items-center justify-center px-4">
      ...
      <p className="mb-8 text-center text-sm text-muted-foreground">
        I can help you find classes, check bookings, and get personalized recommendations.
      </p>
