                  ...
                  {activity.images.slice(1).map((image, i) => {
                    ...
                    return (
                      <div
                        ...
                        className="relative size-24 rounded-xl overflow-hidden bg-muted shrink-0 ring-2 ring-transparent hover:ring-primary transition-all cursor-pointer"
                      >
                        <Image 
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex gap-4">
                      {venue.images?.[0] && (
                        <div className="relative size-24 rounded-xl overflow-hidden bg-muted shrink-0">
                          <Image 
