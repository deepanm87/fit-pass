              ...
              <div className="flex items-center gap-4">
                {userProfile?.imageUrl ? (
                  <Image 
                    ...
                    width={72}
                    height={72}
                    className="size-18 rounded-2xl object-cover shadow-md"
                  />
                ) : (
                  <div className="flex size-18 items-center justify-center rounded-2xl bg-muted shadow-md">
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  <Badge className={`${TIER_COLORS[tierInfo.tier || "none"]} capitalize border-0`}>
                    {tierInfo.tier || "None"}
                  </Badge>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="flex items-start gap-3 rounded-xl bg-muted/50 p-4 transition-colors hover:bg-muted">
                  <TargetIcon className="mt-0.5 size-5 text-primary" />
                  <div>
